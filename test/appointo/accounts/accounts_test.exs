defmodule Appointo.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{active: true, email: "some email", name: "some name"}
    @update_attrs %{active: false, email: "some updated email", name: "some updated name"}
